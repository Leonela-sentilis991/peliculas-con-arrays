...
{
    Console.WriteLine("Ingrese el nombre de la serie #{0}:",( i + 1));
    series[i] = Console.ReadLine();

    Console.WriteLine("Ingrese la categoría de la serie #{0}:", (i + 1));
...
{
    Console.WriteLine("Serie {0}:  y  Categoría: {1}", series[i], categorias[i]);
}
